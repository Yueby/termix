...
export function ListPage<T>({
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="border-b p-3 bg-card overflow-x-auto no-scrollbar">
      ...
      <div className="flex items-center gap-2 border-b px-3 py-2 bg-card overflow-x-auto no-scrollbar flex-nowrap">
        {actionButtons}
